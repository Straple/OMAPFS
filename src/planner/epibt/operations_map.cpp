...
const Path &OperationsMap::get_nodes_path(uint32_t node, uint32_t operation) const {
...
const Path &OperationsMap::get_edges_path(uint32_t node, uint32_t operation) const {
...
const Path &OperationsMap::get_poses_path(uint32_t node, uint32_t operation) const {
