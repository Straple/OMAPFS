...
namespace RHCR {
    ...
    void WHCAStar::print_results() const {
        ...
        std::cout << runtime << "," << num_restarts << "," << num_expanded << "," << num_generated << "," << solution_cost << "," << min_sum_of_costs << "," << avg_path_length << std::endl;
    }
    ...
    void WHCAStar::save_results(const std::string &fileName, const std::string &instanceName) const {
        ...
        stats << runtime << "," << num_restarts << "," << num_restarts << "," << num_expanded << "," << num_generated << "," << solution_cost << "," << min_sum_of_costs << "," << avg_path_length << ","
              << "0"
