...
namespace LNS {
    ...
    namespace Parallel {
        ...
        public:
            ...
            TimeSpaceAStarState(int pos, int orient, int t, float g, float h, int num_of_conflicts, bool arrived, TimeSpaceAStarState *prev) : pos(pos), orient(orient), t(t), g(g), h(h), f(g + h), num_of_conflicts(num_of_conflicts), prev(prev), closed(false), arrived(arrived){};
