...
std::string planner_type_to_string(PlannerType type) {
    switch (type) {
        case PlannerType::PIBT: return "PIBT";
        case PlannerType::PIBT_TF: return "PIBT_TF";
        case PlannerType::EPIBT: return "EPIBT";
        case PlannerType::EPIBT_LNS: return "EPIBT_LNS";
        case PlannerType::PEPIBT_LNS: return "PEPIBT_LNS";
        case PlannerType::WPPL: return "WPPL";
    }
    return "EPIBT";
}
...
std::string scheduler_type_to_string(SchedulerType type) {
    switch (type) {
        case SchedulerType::CONST: return "CONST";
        case SchedulerType::GREEDY: return "GREEDY";
    }
    return "CONST";
}
